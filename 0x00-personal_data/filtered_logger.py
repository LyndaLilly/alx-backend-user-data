...
class RedactingFormatter(logging.Formatter):
    ...
    this update the class to accept a list of strings fields constructor argument.
    invokes format method to filter values of incoming log records using
    fields values will be filtered.
    """
    ...
    def format(self, record: logging.LogRecord) -> str:
        """this filters values of call logs coming in.
...
def get_logger() -> logging.Logger:
    """this returns a logging.Logger object named "user_data".
